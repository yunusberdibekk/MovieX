//
//  MXMovieDetailViewController.swift
//  MovieX
//
...
protocol MXMovieDetailViewControllerProtocol: Alertable, AnyObject {
...
final class MXMovieDetailViewController: UIViewController {
    private var viewModel: MXMovieDetailViewModelProtocol
    ...
    init(movie: Movie, movieDetail: MovieDetail) {
        viewModel = MXMovieDetailViewModel(
            movie: movie,
...
extension MXMovieDetailViewController: MXMovieDetailViewControllerProtocol {
    func prepareWebView() {
