//
//  MXShowCaseTableHeaderView.swift
//  MovieX
//
...
final class MXShowCaseTableHeaderView: UICollectionViewCell {
    static let identifier: String = "MXShowCaseTableHeaderView"
...
extension MXShowCaseTableHeaderView {
